    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#0b0d12]/95 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-2 md:px-10">
        <Link href="/" className="flex items-center gap-2 text-sm font-semibold tracking-[0.18em] text-slate-100 uppercase">
          <span className="inline-flex items-center gap-1.5 rounded-md border border-amber-300/45 bg-amber-500/15 px-2 py-1 text-[11px] font-bold tracking-[0.14em] text-amber-100">
            <span className="font-black">BC</span>
            <span className="h-2.5 w-px bg-amber-200/60" />
            <span className="h-2.5 w-px bg-amber-200/45" />
            <span className="h-2.5 w-px bg-amber-200/35" />
          </span>
          <span className="text-[11px] tracking-[0.14em] text-amber-50">Builder Copilot</span>
        </Link>
