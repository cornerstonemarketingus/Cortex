...
- AI: AI chat wrapper with retry and fixed-window rate limiting
- Auth: JWT (jose)
...
## Module Boundaries
- core: environment, auth, db adapter, API helpers, queue, realtime, AI
...
- capture.service: business-card OCR parsing from image (AI vision-compatible chat request)
...
- Set JWT/Stripe/AI/Pusher environment variables
